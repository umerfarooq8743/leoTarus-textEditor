...
export default function About(props) {
    ...
    let myStyle={
        ...
        backgroundColor:props.mode==='dark'?'#22568b':'white',
    }
    return (
        
        <div style={{color:props.mode==='dark'?'white':'black'}}>
            <h1 className='my-4 px-2'>About Us</h1>
            <div className="accordion" id="accordionExample">
                ...
                {/* <div className="container my-3">
                    <button className='btn btn-danger fw-bolder' type='button' onClick={toggleStyle}> {btnText}</button>
                </div> */}
            </div>
